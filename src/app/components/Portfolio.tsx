...
export default function Portfolio() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute left-1/2 top-0 -translate-x-[54.5%] -z-10"
      ...
      >
        <Image
          ...
          width={480}
          height={600}
          className="rotate-[12deg] shadow-[0_40px_100px_rgba(0,0,0,0.6)]  mt-35"
        />
      </motion.div>
      ...
      <div className="h-88 md:mt-25"></div>
      ...
      {/* Applications */}
      <Reveal>
        <h4 className="text-4xl font-semibold mb-6 text-center text-black md:mt-36 mt-10">
          Applications I Use
        </h4>
      </Reveal>
