...
export default function Showreel({
  ...
  return (
    <motion.section
      ...
      className="relative max-w-6xl mx-auto my-20 px-6 sm:px-10 py-16 rounded-3xl
                 bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_30px_80px_rgba(0,0,0,0.35)]"
    >
      ...
      <section className="px-4 sm:px-6 py-16 relative z-10">
        <div className="flex flex-col md:flex-row items-start md:gap-16 max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold mb-2 text-black text-center">Showreel</h2>
            ...
            <p className="text-gray-950 text-sm sm:text-base mt-4">See more of my work:</p>
          ...
          <motion.div
            className="md:w-1/3 flex justify-center w-2/3 mt-8 ml-16 md:mt-0"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, amount: 0.3 }}
